...
class HootUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => CommentUpdateManyWithoutHootsInput,
  })
  @ValidateNested()
  @Type(() => CommentUpdateManyWithoutHootsInput)
  @IsOptional()
  @Field(() => CommentUpdateManyWithoutHootsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ReactionUpdateManyWithoutHootsInput,
  })
  @ValidateNested()
  @Type(() => ReactionUpdateManyWithoutHootsInput)
  @IsOptional()
  @Field(() => ReactionUpdateManyWithoutHootsInput, {
    nullable: true,
  })
  reactions?: ReactionUpdateManyWithoutHootsInput;
}

export { HootUpdateInput as HootUpdateInput };
